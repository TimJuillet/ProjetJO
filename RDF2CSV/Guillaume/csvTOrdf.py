...
def function_generate_rdf(g, f, namespace: dict, olympicsParameters: dict):
    ...
    for row in reader:
        ...
        if is_team_event:
            ...
            hasMember = []
            constructorRDF.createTeam(teamWritting, teamName, teamDescription, BlankIsDisabled, hasMember, countryName)
        else :
            constructorRDF.createPerson(personWritting, nom, BlankHeight,
        ...
        constructorRDF.createPerformance(performanceWritting, BlankHasResult,
...
csv2rdf = CSV2RDF("../data", "../output", "medal_og_24.csv", "output_medal_og_24.ttl", "all")
